...
export default class Model {
	...
	initPoints() {
		this.loader.load(this.file, (gltf) => {
			...
			gltf.scene.traverse((child) => {
				if (child.isMesh) {
					// Create a material for the points. Customize as needed.
					...
					// Use the mesh's geometry for the points.
					const points = new Points(child.geometry,      PointsMaterial({ color: 0x888888, size: 0.05 });
					)
			...
			// 		delete geometry.attributes.tangent // To ensure it's removed, but this line might be optional depending on how Three.js handles undefined attributes in the current version.
			// 	}
			// })
