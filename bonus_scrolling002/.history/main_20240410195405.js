...
function init() {
	...
	timeline.to(meshes.default.rotation, { duration: 1, x: 100 }, 0.3)
	timeline.to(meshes.standard.rotation, { duration: 1, y: 100 }, 0.7)
...
function handleScroll(event) {
	...
	const progress = Math.abs(virtualScrollPosition / maxScrollPosition)
