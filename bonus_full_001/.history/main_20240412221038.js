...
function flickerLight() {
	let lightIntensityBase = 2 // Base intensity of the light
	let flickerAmount = 3.5 // Maximum deviation from the base intensity
	let flickerSpeed = 2 + Math.random() * 2
	const time = Date.now() * 0.002
	const flicker = Math.sin(time * flickerSpeed) * flickerAmount

	// Apply the calculated flicker effect to the base intensity
	lights.light2.intensity = lightIntensityBase + flicker
}
