...
function init() {
	...
	const loadManager = manager(
		setupConfiguresetupConfiguresetupConfiguresetupConfiguresetupConfiguresetupConfiguresetupConfiguresetupConfigure
	)
...
function setupConfigure() {
	meshes.car.traverse((part) => {
		...
		if (part.name === 'Door_Left_Body_1_0' || 'Door_Right_Body_1_0') {
			carParts.push(part)
		}
