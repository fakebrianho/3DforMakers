...
import MeshReflectorMaterial from './meshReflectiveMaterial'
			...
			gltf.scene.traverse((child) => {
				...
				if (child.name == 'ap_triumph_spitfire_0') {
					...
					const material = new MeshPhysicalMaterial({
						...
						metalness: 0.05, // High metalness value for a metallic appearance
					...
					const mat = new MeshReflectorMaterial({ mirror: 1 })
