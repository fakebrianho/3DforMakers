...
function animate() {
	...
	meshes.planet1.position.x = Math.sin(tick) * 1.5
	meshes.planet1.position.y = Math.cos(tick) * 1.5

	meshes.planet2.rotation.x -= 0.02
	meshes.planet2.rotation.z += 0.01
	meshes.planet2.position.x = Math.sin(tick * -0.4) * 2.5
	meshes.planet2.position.y = Math.cos(tick * -0.4) * 2.5

	meshes.planet3.rotation.y -= 0.02
	meshes.planet3.rotation.x += 0.01
	meshes.planet3.position.x = Math.sin(tick * 1.4) * 3.5
	meshes.planet3.position.y = Math.cos(tick * 1.4) * 3.5

	meshes.planet4.rotation.z += 0.01
	meshes.planet4.rotation.x += 0.005
	meshes.planet4.position.x = Math.sin(tick * -0.8) * 4.5
	meshes.planet4.position.y = Math.cos(tick * -0.8) * 4.5

	meshes.planet5.rotation.y += 0.01
	meshes.planet5.rotation.z -= 0.02

	meshes.planet5.material.displacementScale = Math.sin(tick) * 0.1
	tick += 0.01
